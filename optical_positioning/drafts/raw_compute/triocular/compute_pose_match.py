...
def get_corner_intersection(id_0, id_1, corners_0, corners_1):
    ids, ind_0, ind_1 = np.intersect1d(id_0, id_1, return_indices=True)
    return ids, (
        corners_0[ind_0].reshape((-1, 2)).T,
        corners_1[ind_1].reshape((-1, 2)).T,
    )


ids_0, corners_0 = get_corner_intersection(
    triangulate_corners_ids[0],
    triangulate_corners_ids[1],
    triangulate_corners_all[0],
    triangulate_corners_all[1],
)
obj_pos_0 = compute_obj_pos(projection_matrix[0], projection_matrix[1], *corners_0)

ids_1, corners_1 = get_corner_intersection(
    triangulate_corners_ids[1],
    triangulate_corners_ids[2],
    triangulate_corners_all[1],
    triangulate_corners_all[2],
)
obj_pos_1 = compute_obj_pos(projection_matrix[1], projection_matrix[2], *corners_1)

ids_2, corners_2 = get_corner_intersection(
    triangulate_corners_ids[0],
    triangulate_corners_ids[2],
    triangulate_corners_all[0],
    triangulate_corners_all[2],
